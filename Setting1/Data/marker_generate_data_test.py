...
with open('time_alpha_test_1.txt','r') as in_file:
    for x in in_file:
        Tx = [float(y) for y in x.strip().split()] 

with open('time_beta_test_1.txt','r') as in_file:
    for x in in_file:
        Tz = [float(y) for y in x.strip().split()] 

with open('time_gamma_test_1.txt','r') as in_file:
    for x in in_file:
...
event_y11 = event_data(400, 0.9, 0.1)
event_y12 = event_data(400, 0.7, 0.3)    
event_y21 = event_data(400, 0.3, 0.7)
event_y22 = event_data(400, 0.1, 0.9)  
...
#######--------write_data_in_file---------#######
with open('event_alpha_test_1.txt', 'w') as output:
    for i in range(1):
        mstr = ''
        for ix in event_x:
            mstr += str(ix)+" "     
...
with open('event_beta_test_1.txt', 'w') as output:
    for i in range(1):
        mstr = ''
        for ix in event_z:
            mstr += str(ix)+" "     
...
with open('event_gamma_test_1.txt', 'w') as output:
    mstr = ''
    for ix in event_y:
        mstr += str(ix)+" "     
    output.write(mstr)
