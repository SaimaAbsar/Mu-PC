...
def_opts = tf_rmtpp.rmtpp_core_u_pc_m1i1.def_opts
...
def cmd(event_train_file_x, time_train_file_x, event_test_file_x, time_test_file_x, event_train_file_z, time_train_file_z,
    ...
    data = tf_rmtpp.utils_m1i1.read_data(
    ...
    tf_rmtpp.utils_m1i1.data_stats(data)

    rmtpp_mdl = tf_rmtpp.rmtpp_core_u_pc_m1i1.RMTPP(
        sess=sess,
        ...
        cpu_only=cpu_only,
        _opts=tf_rmtpp.rmtpp_core_u_pc_m1i1.def_opts
    )
    ...
    print(h.shape)
    np.savetxt('./hidden_states/h_m1i1.txt', h)
    ...
    with open('Loss_test_model1_i1.txt', 'w') as output:
