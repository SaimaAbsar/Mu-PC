...
def evaluate_nn_3(alpha, beta, C_):
    ...
    subprocess.call(['python','run_u_pc_m1i3.py', a.event, a.time, a.event_test, a.time_test, c_0.event, c_0.time, c_0.event_test, c_0.time_test, c_1.event, c_1.time, c_1.event_test, c_1.time_test, c_2.event, c_2.time, c_2.event_test, c_2.time_test, b.event, b.time, b.event_test, b.time_test,'--epochs', str(1)])

    subprocess.call(['python','run_u_pc_m2i3.py', a.event, a.time, a.event_test, a.time_test, c_0.event, c_0.time, c_0.event_test, c_0.time_test, c_1.event, c_1.time, c_1.event_test, c_1.time_test, c_2.event, c_2.time, c_2.event_test, c_2.time_test, b.event, b.time, b.event_test, b.time_test, '--epochs', str(1)]) 
...
np.savetxt('G_phase-1_Set1.txt', G.values, fmt='%d', delimiter="\t", header="X\tY\tZ")
