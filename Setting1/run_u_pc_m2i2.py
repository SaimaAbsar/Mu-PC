...
def_opts = tf_rmtpp.rmtpp_core_u_pc_m2i2.def_opts
...
def cmd(event_train_file_x, time_train_file_x, event_test_file_x, time_test_file_x, event_train_file_z0, time_train_file_z0,
        ...
        event_test_file_z1, time_test_file_z1, event_train_file_y, time_train_file_y, event_test_file_y, time_test_file_y,
    ...
    data = tf_rmtpp.utils_m2i2.read_data(
    ...
    tf_rmtpp.utils_m2i2.data_stats(data)

    rmtpp_mdl = tf_rmtpp.rmtpp_core_u_pc_m2i2.RMTPP(
        sess=sess,
        ...
        cpu_only=cpu_only,
        _opts=tf_rmtpp.rmtpp_core_u_pc_m2i2.def_opts
    )
    ...
    print(h.shape)
    np.savetxt('./hidden_states/h_m2i2.txt', h)
    ...
    with open('Loss_test_model2_i2.txt', 'w') as output:
