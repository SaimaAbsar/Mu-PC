...
def_opts = tf_rmtpp.rmtpp_core_u_pc_m2i1.def_opts
...
@click.argument('event_train_file_z')
@click.argument('time_train_file_z')
@click.argument('event_test_file_z')
@click.argument('time_test_file_z')
...
def cmd(event_train_file_x, time_train_file_x, event_test_file_x, time_test_file_x, event_train_file_z, time_train_file_z,
        event_test_file_z, time_test_file_z, event_train_file_y, time_train_file_y, event_test_file_y, time_test_file_y,
    ...
    data = tf_rmtpp.utils_m2i1.read_data(
        ...
        event_train_file_z=event_train_file_z,
        event_test_file_z=event_test_file_z,
        time_train_file_z=time_train_file_z,
        time_test_file_z=time_test_file_z,
    ...
    tf_rmtpp.utils_m2i1.data_stats(data)

    rmtpp_mdl = tf_rmtpp.rmtpp_core_u_pc_m2i1.RMTPP(
        sess=sess,
        ...
        cpu_only=cpu_only,
        _opts=tf_rmtpp.rmtpp_core_u_pc_m2i1.def_opts
    )
    ...
    print(h.shape)
    np.savetxt('./hidden_states/h_m2i1.txt', h)
    ...
    with open('Loss_test_model2_i1.txt', 'w') as output:
