...
def_opts = tf_rmtpp.rmtpp_core_u_pc_m1i0.def_opts
...
def cmd(event_train_file_x, time_train_file_x, event_test_file_x, time_test_file_x, event_train_file_y, time_train_file_y, 
        event_test_file_y, time_test_file_y, summary_dir, num_epochs, restart, train_eval, test_eval, scale,
    ...
    data = tf_rmtpp.utils_m1i0.read_data(
    ...
    tf_rmtpp.utils_m1i0.data_stats(data)

    rmtpp_mdl = tf_rmtpp.rmtpp_core_u_pc_m1i0.RMTPP(
        sess=sess,
        ...
        cpu_only=cpu_only,
        _opts=tf_rmtpp.rmtpp_core_u_pc_m1i0.def_opts
    )
    ...
    np.savetxt('./hidden_states/h_m1i0.txt', h)
