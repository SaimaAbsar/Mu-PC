...
# if sourced as a main program
if __name__=="__main__":
    '''
    g = Graph(4) 
    g.addEdge(0, AdjNode(1, OUT)); 
    g.addEdge(0, AdjNode(2, OUT)); 
    g.addEdge(0, AdjNode(3, OUT)); 

    g.addEdge(1, AdjNode(0, IN)); 
    g.addEdge(2, AdjNode(0, IN)); 
    g.addEdge(3, AdjNode(0, IN)); 

    g.addEdge(2, AdjNode(0, OUT)); 
    g.addEdge(2, AdjNode(1, OUT)); 

    g.addEdge(0, AdjNode(2, IN)); 
    g.addEdge(1, AdjNode(2, IN)); 

    g.addEdge(3, AdjNode(1, OUT));
    g.addEdge(1, AdjNode(3, IN));

    g.addEdge(3, AdjNode(3, OUT));
    #g.addEdge(3, AdjNode(3, IN));
    '''
    g = Graph(3) 
    g.addEdge(0, AdjNode(1, OUT)); 
    g.addEdge(0, AdjNode(2, OUT)); 
    ...
    g.addEdge(1, AdjNode(0, OUT)); 
    g.addEdge(1, AdjNode(2, OUT)); 

    g.addEdge(0, AdjNode(1, IN)); 
    g.addEdge(2, AdjNode(1, IN)); 
    ...
    g.addEdge(1, AdjNode(1, OUT));
    g.addEdge(2, AdjNode(2, OUT));
    g.addEdge(0, AdjNode(0, OUT));
    #g.addEdge(3, AdjNode(3, IN));
    ...
    C = [2,0]
    g.findConnectingRoute(s, d, C)

    # Print recorded paths
    print("\n\nInfo: Printing recorded paths")
    g.printRecordedPaths()
